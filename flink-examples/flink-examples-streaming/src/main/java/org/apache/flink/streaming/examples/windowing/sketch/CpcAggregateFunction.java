...
public class CpcAggregateFunction extends SketchAggregateFunction<Tuple3<String, Long, String>, Tuple3<CpcSketch, Long, Set<String>>, Double> {

    private static final Logger LOG = LoggerFactory.getLogger(CpcAggregateFunction.class);
