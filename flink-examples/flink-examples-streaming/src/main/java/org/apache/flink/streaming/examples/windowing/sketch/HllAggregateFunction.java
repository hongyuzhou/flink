...
public class HllAggregateFunction extends SketchAggregateFunction<Tuple3<String, Long, String>, Tuple3<HllSketch, Long, Set<String>>, Double> {

    private static final Logger LOG = LoggerFactory.getLogger(HllAggregateFunction.class);
